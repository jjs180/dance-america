...
function returnRepetitionWrapper(index) {
	return "<div class='repetitionDetail-wrapper' id='repetitionDetail-wrapper-"+index+"'><div id='repetitionParameter-wrapper-"+index+"'><select name='editEventForm[repetitions]["+index+"][repetition_parameter]' class='repetitionParameter' id='editEventForm-repetitionParameter-"+index+"' data-validators='required' onchange='changeRepetitionParameter("+index+")'><option value='years'>Yearly</option><option value='months'>Monthly</option><option value='weeks'>Weekly</option><option value='days'>Every day</option><option value='one time event'>One time event</option></select></div><div id='repetitionSpacing-wrapper-"+index+"' class='repetitionSpacing-wrapper'><span>The event will repeat every</span> <input id='editEventForm-repetitionSpacing-"+index+"' type='text' name='editEventForm[repetitions]["+index+"][repetition_spacing]' data-validators='required' /> <span id='repetitionFactor-wrapper-"+index+"'>weeks on</span>&nbsp;</div> <div><select class='daysOfMonth-selector' name='editEventForm[repetitions]["+index+"][day_of_month]' id='daysOfMonth-select-"+index+"' onchange='changeDayOfMonth("+index+")'><option value='' selected='selected'></option><option value='last'>last</option><option value='1'>1st</option><option value='2'>2nd</option><option value='3'>3rd</option><option value='4'>4th</option><option value='5'>5th</option><option value='6'>6th</option><option value='7'>7th</option><option value='8'>8th</option><option value='9'>9th</option><option value='10'>10th</option><option value='11'>11th</option><option value='12'>12th</option><option value='13'>13th</option><option value='14'>14th</option><option value='15'>15th</option><option value='16'>16th</option><option value='17'>17th</option><option value='18'>18th</option><option value='19'>19th</option><option value='20'>20th</option><option value='21'>21st</option><option value='22'>22nd</option><option value='23'>23rd</option><option value='24'>24th</option><option value='25'>25th</option><option value='26'>26th</option><option value='27'>27th</option><option value='28'>28th</option><option value='29'>29th</option><option value='30'>30th</option><option value='31'>31st</option></select> <select class='daysOfWeek-selector' name='editEventForm[repetitions]["+index+"][day_of_week]' id='daysOfWeek-select-"+index+"' onchange='changeDayOfWeek("+index+")'><option selected='selected'></option><option value='day'>day</option><option value='Sunday'>Sunday</option><option value='Monday'>Monday</option><option value='Tuesday'>Tuesday</option><option value='Wednesday'>Wednesday</option><option value='Thursday'>Thursday</option><option value='Friday'>Friday</option><option value='Saturday'>Saturday</option></select> <div id='monthsOfYear-wrapper-"+index+"'>in <select name='editEventForm[repetitions]["+index+"][month_of_year]' id='monthsOfYear-select-"+index+"' class='monthsOfYear-select' onchange='changeMonthOfYear("+index+")'><option selected='selected'></option><option value='1'>January</option><option value='2'>February</option><option value='3'>March</option><option value='4'>April</option><option value='5'>May</option><option value='6'>June</option><option value='7'>July</option><option value='8'>August</option><option value='9'>September</option><option value='10'>October</option><option value='11'>November</option><option value='12'>December</option></select></div> <a onclick='deleteRepetition("+index+")' id='deleteRepetitionButton-"+index+"' class='btn negative deleteRepetitionButton'>-</a></div></div>";
}
...
$j('.addRepetitionButton').click(function() {
	...
	index = idNumber+1;
	var repetitionWrapperString = returnRepetitionWrapper(index);
	$j(repetitionWrapperString).insertAfter('.repetitionDetail-wrapper:last-of-type');
...
function changeRepetitionParameter(index) {
	...
	if (frequency != 'one time event') {
		...
		$j('.repetitionDetail-wrapper').each(function() {
			var eachRepIdString = $j(this).children('div:first').attr('id');
			...
			if ($j('.repetitionDetail-wrapper').length == 1) {
				...
				$j('.monthsOfYear-wrapper').css('display', 'none');
				$j('.addRepetitionButton').css('display', 'none');
			}
