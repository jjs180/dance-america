...
<form id="editVenueForm" class="NWForm" action="{url 'venues/edit' [venueId => $venueModel.id]}" method="post">
	...
	<div>
		...
		<input id="editVenueForm-postalCode" type="text" name="editVenueForm[postal_code]" value="{$venueModel.postal_code}" />
	</div>
	<div>
	...
	<div>
		...
		<textarea id="editVenueForm-specialNotes" type="text" name="editVenueForm[special_notes]" value="{$venueModel.special_notes}" placeholder='Special Notes'>{$venueModel.special_notes}</textarea>
	</div>
	<div>
		<label for="editVenueForm-contactEmail">Your Email</label>
		<div>
			<input id="editVenueForm-contactEmail" type="text" name="editVenueForm[contact_email]" placeholder="Email" data-validators="validate-email" {if $venueModel.contact_email}value="{$venueModel.contact_email}" {else}value="{$loggedInMember.email}"{/if} />
		</div>
