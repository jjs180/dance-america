<?php /* Smarty version Smarty-3.1-DEV, created on 2014-11-08 18:01:59
         compiled from "/Users/cara/Sites/dance_america/module/People/view/people/partials/_addPersonScript.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1809602747545e4c8745eb65-98599704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8df670edebc9dac5c8d54ca662f186d1a2592f6' => 
    array (
      0 => '/Users/cara/Sites/dance_america/module/People/view/people/partials/_addPersonScript.tpl',
      1 => 1414428831,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1809602747545e4c8745eb65-98599704',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1-DEV',
  'unifunc' => 'content_545e4c874a8467_17524623',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545e4c874a8467_17524623')) {function content_545e4c874a8467_17524623($_smarty_tpl) {?><script type="text/javascript" charset="utf-8">
function addInput() {
...
function deleteRepetition(index) {
	...
	if ($j('.repetitionDetail-wrapper').length == 1) {
		...
		$j('#addEventForm-repetitionParameter-'+index).val('one time person');
...
function changeRepetitionParameter(index) {
	...
	if (frequency != 'one time person') {
		$j('#personWillStop-wrapper').css('display', 'block');
		$j('#personEndDate-wrapper').css('display', 'none');
		$j('#deleteRepetitionButton-'+index).css('display', 'inline-block');
...
$j('#addEventForm-willStop').change(function() {
	...
	if (willStop=='1') $j('#personEndDate-wrapper').css('display', 'block');
	else  $j('#personEndDate-wrapper').css('display', 'none');
});
