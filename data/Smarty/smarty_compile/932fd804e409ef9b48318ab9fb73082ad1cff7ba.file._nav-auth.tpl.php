<?php /* Smarty version Smarty-3.1-DEV, created on 2014-10-27 18:00:39
...
<?php if ($_valid && !is_callable('content_5439c8d73a55f1_03001373')) {function content_5439c8d73a55f1_03001373($_smarty_tpl) {?><ul class='nav-auth'>
	<?php if (isset($_smarty_tpl->tpl_vars['loggedInMember']->value)){?>
		...
		<li <?php if ((($tmp = @$_smarty_tpl->tpl_vars['route']->value)===null||$tmp==='' ? '' : $tmp)=='account/my-people'){?>class='active'<?php }?>><a href="<?php echo $_smarty_tpl->smarty->registered_objects['zf'][0]->url('account/my-people'); ?>">My Instructors</a></li>
