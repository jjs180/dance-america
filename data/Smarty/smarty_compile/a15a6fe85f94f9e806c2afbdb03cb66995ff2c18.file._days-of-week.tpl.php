...
<?php if ($_valid && !is_callable('content_5327c907d8f929_93152769')) {function content_5327c907d8f929_93152769($_smarty_tpl) {?><option {if $smarty.post && $smarty.post['siteSearchForm']['location']['state'] == 'CA'}selected='selected'{/if} selected='selected'></option>
